...
struct Generator {
    ...
    func generate(arguments: Arguments) async throws {
        ...
        let buildMode = arguments.buildMode
        ...
        for entry in consolidationMapEntries {
            ...
            let platformVariants = key.sortedIds.map { id in
                ...
                return Target.PlatformVariant(
                    ...
                    entitlements: topLevelTargetAttributes?.entitlements,
            ...
            if buildMode.usesBazelModeBuildScripts && !isResourceBundle {
            ...
            var compileTargetName =
                aTopLevelTargetAttributes?.compileTargetName ?? ""
            if compileTargetName.isEmpty {
                compileTargetName = entry.label.name
            }
